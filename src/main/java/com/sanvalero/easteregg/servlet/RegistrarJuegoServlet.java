...
/**
 * Servlet que añade un juego, descripción, desarrollador y genero a la base de
 * datos
 */
...
public class RegistrarJuegoServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws
        ...
        try {
            ...
            out.write("Game has been registered successfully!");
        } catch (SQLException sqle) {
            out.write("Fail to register a game");
