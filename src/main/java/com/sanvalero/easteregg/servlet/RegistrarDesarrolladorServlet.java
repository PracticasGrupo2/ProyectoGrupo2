...
/**
 * Servlet que añade un desarrollador, email y ubicación a la base de datos
 */
...
public class RegistrarDesarrolladorServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws
        ...
        try {
            ...
            out.write("Developer has been registered successfully!");
          
        } catch (SQLException sqle) {
            out.write("Fail to register a developer");
